...
public class PlayDouble {
    ...
    public PlayDouble(String user1, String user2, String uri, String songName, String artistName, String imageURL, Integer progressChanged, Boolean isPlay, Boolean isRepeat) {
        this.user1 = user1;
        this.user2 = user2;
        this.uri = uri;
